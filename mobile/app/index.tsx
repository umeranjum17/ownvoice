...
export default function Home() {
  ...
  const rules = (nextPaused: boolean, nextEnabled: boolean) => { void native().setBubbleRules({ paused: nextPaused, on: nextEnabled ? testApps : ['com.android.chrome'], off: nextEnabled ? [] : ['dev.ownvoice.next'], defaults: [] }).catch(() => {}); };
