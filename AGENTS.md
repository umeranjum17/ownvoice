...
- No user-facing string may carry technical words (model names, scores, "characters"); `PlainWordsTest` scans `src/main` for them, and the technical detail belongs in `README.md`.
